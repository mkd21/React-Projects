...
export const Cards = () =>{
    ...
    const {userId ,  title , body} = useContext(ContextData);
    ...
    return(
        ...
        <div className="cardParent border-l-4 border-gray-200 bg-slate-300 rounded-lg">
            ...
            <section className="mt-6 ml-6 mb-5">
                <button className="bg-emerald-600 text-blue-100 mr-5 w-20 p-2 rounded-3xl">Edit</button>
                <button className="bg-red-600 text-yellow-200 w-20 p-2 rounded-2xl">Delete</button>
            </section>
